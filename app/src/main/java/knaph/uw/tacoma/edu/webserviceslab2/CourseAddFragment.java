package knaph.uw.tacoma.edu.webserviceslab2;
...
public class CourseAddFragment extends Fragment {
    ...
    private final static String COURSE_ADD_URL
            = "http://cssgate.insttech.washington.edu/~knaph/addCourse.php?";
...
//    private OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCourseIdEditText = (EditText) v.findViewById(R.id.course_field);
        mCourseShortDescEditText = (EditText) v.findViewById(R.id.s_desc_field);
        mCourseLongDescEditText = (EditText) v.findViewById(R.id.l_desc_field);
        mCoursePrereqsEditText = (EditText) v.findViewById(R.id.prereqs_field);
